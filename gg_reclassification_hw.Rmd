...
Which summarized the sequences of starting at 1855 and ending at 4051.

Then I more or less followed the MiSeq_SOP using start=1855 and end=4051 for the first pcr.seq command to customized the gg database for these sequences:
